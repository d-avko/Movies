//
//  AdaptiveUIImageView.swift
//  movies
//
//  Created by Denis Maximenko on 3/7/20.
  ...
  private func updateAspectRatioConstraint() {
    ...
    if let imageSize = image?.size, imageSize.height != 0
    {
      ...
      // a priority above fitting size level and below low
        c.priority = UILayoutPriority.init( (UILayoutPriority.defaultLow.rawValue + UILayoutPriority.fittingSizeLevel.rawValue) / 2.0 )
